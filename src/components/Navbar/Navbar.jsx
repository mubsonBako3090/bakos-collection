...
export default function Navbar() {
  ...
  const [isCollapsed, setIsCollapsed] = useState(true); // controls navbar collapse
  ...
  // Handle cart count and login state
  useEffect(() => {
